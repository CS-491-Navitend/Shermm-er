...
export class Game extends Scene {
  ...
  getColors(){
    ...
    colorProperties = [colors[index], shermies[index], tints[index]];
    ...
    getBomb(shermie) {
        ...
        if (this.isBomb) {
           ...
           // console.log("Creating new bomb timer event...");
            ...
            // If it's not a bomb, stop any existing bomb timer event
            if (this.bombTimerEvent) {
                this.bombTimerEvent.remove();
                this.bombTimerEvent = null;
            }

            // Clear the bomb timer text
            if (this.bombTimerText) {
                this.bombTimerText.setText("");
            }
        }
    }
}
