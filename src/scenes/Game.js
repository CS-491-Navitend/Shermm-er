...
export class Game extends Scene {
  ...
  create(data) {
    ...
    const goal = this.add.image(this.width / 2, roadEnd - this.safeZoneSize - this.safeZoneSize / 2 - roadWidth * this.numberOfRoads, "lavaGoal");
    goal.setScale(1, 1);
    ...
    this.physics.add.overlap(this.shermie, lavaZone, () => {
