...
export class Game extends Scene {
  constructor() {
   super("Game");
    ...
    this.physics.add.overlap(this.shermie, this.vehicles, this.reset, null, this);
...
update() {
    ...
    if (!this.cursors.left.isDown && !this.cursors.right.isDown && !this.cursors.up.isDown && !this.cursors.down.isDown){this.canMove = true;}
...
//Plays the GamerOver screen    
  gameOver() {
    console.log('Game Over!');
      this.scene.start("GameOver", { winCount: this.winCount, resetCount: this.resetCount });
    }
